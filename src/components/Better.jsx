      ...
      <div className="wrapper">
        <div className="better left">
          <h3 className="better-title">
            How <span className="blue-text">LSPU IPTBM Work to Serve </span>You
            Better
          </h3>
        </div>
        <div className="better right">
          <p className="better description">
            We are dedicated to serving you better by offering comprehensive and
            tailored services that ensure the effective management and
